...
function read_data() {
    ...
    <h2 class="hd" >Read Data Program Studi</h2>
    <table border=1 cellpadding="10">
        <tr>
            <td colspan="5"><a class="input" href="curd_prodi.php?a=input">INPUT</a></td>
        </tr>
        <tr class="td">
            <td>ID</td>
            <td>KODE</td>
        ...
        <tr>
            ...
            <td>
                <a class="ed" href="curd_prodi.php?a=edit&id=<?php echo $row['idprodi']; ?>">EDIT</a>
                <a class="hp" href="curd_prodi.php?a=hapus&id=<?php echo $row['idprodi']; ?>">HAPUS</a>
            </td>
        </tr>
        <?php } ?>
    </table>
...
function input_data() {
    ...
    <form action="curd_prodi.php?a=list" method="post">
        ...
        Kode Prodi
        <input type="text" placeholder="Input kode prodi" name="kdprodi" maxlength="6" size="6" value="<?php echo trim($row["kdprodi"]) ?>" />
        <br>
        Nama Prodi
        <input type="text" placeholder="Input nama prodi" name="nmprodi" maxlength="70" size="70" value="<?php echo trim($row["nmprodi"]) ?>" />
        <br>
        Akreditasi Prodi
